...
final class ExploreDetailVC: UIViewController {
    ...
    private let markAsWatchedButton = FFButton(title: "Mark As Watched", systemImageName: "rectangle.badge.plus", accessibilityIdentifier: "ExploreDetailVC_MarkAsWatchedButton", accessibilityHint: "Adds film to Watched list")
